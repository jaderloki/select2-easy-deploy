...
S2.define('select2/selection/base',[
  ...
  BaseSelection.prototype.render = function () {
    var $selection = $(
      '<span class="select2-selection h-100 row mx-0" role="combobox" ' +
...
S2.define('select2/selection/single',[
  ...
  SingleSelection.prototype.render = function () {
	...
	**/
    $selection.html(
      ...
      '<span class="select2-selection__arrow col-auto order-3" role="presentation">' +
  ...
  SingleSelection.prototype.update = function (data) {
    ...
    if($(selection.element).attr("title") != undefined){
        var title = $(selection.element).attr("title");
    }else{
...
S2.define('select2/core',[
  ...
  Select2.prototype._resolveWidth = function ($element, method) {
    ...
    if (method == 'element') {
      ...
      if (elementWidth <= 0) {
        //return 'auto';
        //CAFFE troquei para 100% para expandir largura dinamicamente
        return '100%';
      }
